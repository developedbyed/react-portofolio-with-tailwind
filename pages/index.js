      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-9 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full md:w-80 md:h-80 w-50 h-60 relative overflow-hidden mt-20 md:h-96 md:w-96">
              <Image
                src={deved}
                layout="fill"
                objectFit="cover"
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              gained valuable experience working in both startup and corporate
              (MNC) environments. My journey includes hands-on roles in software
              ...
              development, I&rsquo;m well-equipped to deliver innovative
              solutions for your projects and initiatives.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a wide range of services, including augmented reality
              (AR) development, programming and consultation.
            </p>
          </div>
